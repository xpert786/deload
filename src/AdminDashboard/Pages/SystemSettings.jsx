    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-[#4D6080] mb-2">Admin Name</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-[#4D6080] mb-2">System Configuration</label>
            <textarea
              rows={4}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#003F8F]"
