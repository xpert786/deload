...
//               <div className="flex flex-wrap items-center gap-3">
//                 <div className="flex items-center rounded-lg border border-[#CBD8FF] p-2">
...
//             <p className="text-lg font-semibold text-[#0A3D91] font-[poppins]">Number of training Session</p>
